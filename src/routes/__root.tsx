...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Amr Elbusaily, SEO specialist Cairo, media buyer Egypt, media buying, Google Ads, Meta Ads, e-commerce growth, technical SEO, e-commerce SEO" },
