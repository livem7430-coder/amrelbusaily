  ...
  return (
    <div className="min-h-screen" dir="rtl" lang="ar">
      ...
      <main>
        ...
        <section className="border-y border-border bg-surface/30"><div className="mx-auto grid max-w-6xl gap-6 px-6 py-16 md:grid-cols-3"><InfoCard title="FAQ حقيقي" text="كل موضوع في الخريطة له 3 أسئلة مبدئية بالعربي والإنجليزي، تُراجع وتُوسع داخل المقال بدل حشو Schema." /><InfoCard title="سوق واضح" text="مصر والخليج لهم عناقيد منفصلة وسياق مختلف، مع شفافية كاملة حول تقديم الخدمة عن بعد من القاهرة." /><InfoCard title="نشر تدريجي" text="لا ننشر 500 صفحة رقيقة. كل دفعة تُكتب وتُراجع ثم تُفهرس بعد اكتمال قيمتها للقارئ." /></div></section>
      </main>
