    ...
    handlers: {
      GET: async () => {
        ...
        const entries: {
          ...
          { path: "/seo-expert-saudi", changefreq: "monthly", priority: "0.9", lastmod: today },
          { path: "/ar/seo-expert-saudi", changefreq: "monthly", priority: "0.9", lastmod: today },
          { path: "/seo-expert-uae", changefreq: "monthly", priority: "0.9", lastmod: today },
          { path: "/ar/seo-expert-uae", changefreq: "monthly", priority: "0.9", lastmod: today },
