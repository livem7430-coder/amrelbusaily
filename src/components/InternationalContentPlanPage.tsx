...
export function internationalContentPlanHead() {
  ...
  const description = "A 64-article English content plan for International SEO, US SEO and European SEO, organized by market, intent, supporting keywords, FAQs and internal links.";
  return {
    meta: [
      { title },
