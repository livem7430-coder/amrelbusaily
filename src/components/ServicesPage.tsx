...
function getCopy(lang: Language): Copy {
  if (lang === "ar") {
    return {
      ...
      answer: "أقدم استراتيجية واستشارات SEO، بحث الكلمات، السيو التقني والداخلي والخارجي، Content SEO، International SEO، AI SEO وAEO/GEO، التجارة الإلكترونية، Growth Marketing، B2B demand generation، CRO، Analytics، Marketing Automation، والاستشارات التسويقية. يتم اختيار المزيج حسب هدف المشروع ومرحلته، وليس شراء كل الخدمات بلا ترتيب.",
      servicesTitle: "كل الخدمات في منظومة واحدة",
      services: [
        { label: "01 · SEO", title: "استراتيجية واستشارات SEO", description: "خطة بحث وتشخيص وتنفيذ تربط الكلمات والصفحات والمحتوى والقياس بالهدف التجاري.", href: "/ar/services/seo-strategy-consulting", link: "استكشف خدمة الاستراتيجية ←" },
        { label: "02 · Research", title: "Keyword Research & Strategy", description: "بحث الكلمات، تحليل المنافسين، Search Intent، Keyword Mapping وClustering لبناء خريطة صفحات قابلة للتنفيذ.", href: "/ar/services/keyword-research-strategy", link: "استكشف بحث الكلمات ←" },
        { label: "03 · Technical", title: "Technical SEO & Audits", description: "فحص الزحف والفهرسة والسرعة والروابط والـSchema والـcanonical ومشاكل JavaScript وعمليات النقل.", href: "/ar/services/technical-seo-audits", link: "استكشف SEO التقني ←" },
        { label: "04 · Content", title: "Content SEO & SEO Copywriting", description: "محتوى يجيب عن السؤال مبكرًا، يشرح بعمق، يخدم نية البحث، ويربط القارئ بالصفحة أو الخدمة التالية.", href: "/ar/services/content-seo-copywriting", link: "استكشف Content SEO ←" },
        { label: "05 · International", title: "International & Multilingual SEO", description: "توسّع منظم للأسواق واللغات مع Localization وhreflang وبنية دولية دون صفحات مدن مكررة أو ادعاء وجود محلي.", href: "/ar/services/international-multilingual-seo", link: "استكشف International SEO ←" },
        { label: "06 · AI Search", title: "AI SEO, AEO & GEO", description: "تحسين قابلية الفهم والإجابة للبحث التقليدي ومحركات الإجابة والأنظمة التوليدية مع الحفاظ على جودة المحتوى.", href: "/ar/services/ai-seo-aeo-geo", link: "استكشف AI Search ←" },
        { label: "07 · E-commerce", title: "E-commerce SEO & Growth", description: "هيكل المتجر، صفحات التصنيفات والمنتجات، Product Schema، التحويل، التحليلات ومسارات الشراء العضوية.", href: "/ar/services/ecommerce-seo-growth", link: "ناقش نمو المتجر ←" },
        { label: "08 · Growth", title: "Growth Marketing", description: "Demand generation، Funnels، CRM، Lifecycle، تأهيل العملاء ومحتوى متوافق مع المبيعات لشركات الخدمات وB2B.", href: "/ar/services/growth-marketing-demand-generation", link: "استكشف Growth Marketing ←" },
        { label: "09 · Authority", title: "Off-Page SEO & Digital PR", description: "استراتيجية بناء سلطة واكتساب روابط وDigital PR بطريقة مرتبطة بالموضوع والسمعة، لا شراء روابط عشوائية.", href: "/ar/services/off-page-seo-digital-pr", link: "استكشف بناء السلطة ←" },
        { label: "10 · Local", title: "Local & Mobile SEO", description: "تحسين الظهور المحلي وتجربة الجوال وGoogle Business Profile عندما يكون الموقع أو السوق المحلي جزءًا حقيقيًا من العرض.", href: "/ar/services/local-mobile-seo", link: "استكشف Local SEO ←" },
        { label: "11 · Measurement", title: "Analytics, GA4 & Search Console", description: "تقارير تربط الظهور والنقرات والصفحات وجودة الزيارات والاستفسارات بدل الاكتفاء بترتيب كلمة واحدة.", href: "/ar/services/analytics-measurement", link: "ناقش القياس ←" },
        { label: "12 · Operations", title: "CRO & Marketing Automation", description: "تحسين الخطوة التالية، تنظيم الـleads، وأتمتة عمليات التسويق وn8n عندما تخدم العملية هدفًا واضحًا.", href: "/ar/services/cro-marketing-automation", link: "ناقش CRO والأتمتة ←" },
        { label: "13 · Consulting", title: "Marketing Consulting", description: "التموضع والجمهور والقنوات والعروض وأولويات التشغيل للبراندات التي تحتاج قرارات تسويقية أوضح.", href: "/ar/services/marketing-consulting", link: "استكشف الاستشارات التسويقية ←" },
      ],
  ...
  return {
    ...
    answer: "Services include SEO strategy and consulting, keyword research, technical, on-page and off-page SEO, Content SEO, International SEO, AI SEO and AEO/GEO, e-commerce growth, Growth Marketing, B2B demand generation, CRO, analytics, marketing automation and Marketing Consulting. The right mix depends on the business constraint and commercial goal—not on buying every service at once.",
    servicesTitle: "The full service system",
    services: [
      { label: "01 · SEO", title: "SEO Strategy & Consulting", description: "Research, diagnosis and execution that connect keywords, pages, content and measurement to a commercial goal.", href: "/services/seo-strategy-consulting", link: "Explore the strategy service →" },
      { label: "02 · Research", title: "Keyword Research & Strategy", description: "Keyword research, competitor analysis, search intent, keyword mapping and clustering for an actionable page plan.", href: "/services/keyword-research-strategy", link: "Explore Keyword Research →" },
      { label: "03 · Technical", title: "Technical SEO & Audits", description: "Crawlability, indexing, speed, links, schema, canonical, JavaScript SEO and migration diagnostics.", href: "/services/technical-seo-audits", link: "Explore technical SEO →" },
      { label: "04 · Content", title: "Content SEO & SEO Copywriting", description: "Content that answers early, explains deeply, matches intent and guides a reader to the next useful page or service.", href: "/services/content-seo-copywriting", link: "Explore Content SEO →" },
      { label: "05 · International", title: "International & Multilingual SEO", description: "Structured expansion across languages and markets with localization, hreflang and honest market positioning.", href: "/services/international-multilingual-seo", link: "Explore International SEO →" },
      { label: "06 · AI Search", title: "AI SEO, AEO & GEO", description: "Improve how content is understood and answered across search engines, answer engines and generative systems without lowering quality.", href: "/services/ai-seo-aeo-geo", link: "Explore AI search →" },
      { label: "07 · E-commerce", title: "E-commerce SEO & Growth", description: "Store architecture, category and product pages, product schema, conversion paths, analytics and organic buying journeys.", href: "/services/ecommerce-seo-growth", link: "Discuss store growth →" },
      { label: "08 · Growth", title: "Growth Marketing", description: "Demand generation, funnels, CRM, lifecycle, lead qualification and sales-aligned content for services and B2B.", href: "/services/growth-marketing-demand-generation", link: "Explore Growth Marketing →" },
      { label: "09 · Authority", title: "Off-Page SEO & Digital PR", description: "Reputation and link-earning strategies tied to relevance and authority, not random link purchases.", href: "/services/off-page-seo-digital-pr", link: "Explore authority building →" },
      { label: "10 · Local", title: "Local & Mobile SEO", description: "Local visibility, mobile experience and Google Business Profile improvements when local demand is genuinely part of the offer.", href: "/services/local-mobile-seo", link: "Explore Local SEO →" },
      { label: "11 · Measurement", title: "Analytics, GA4 & Search Console", description: "Reporting that connects visibility, clicks, pages, visit quality and enquiries instead of one keyword position.", href: "/services/analytics-measurement", link: "Discuss measurement →" },
      { label: "12 · Operations", title: "CRO & Marketing Automation", description: "Improve the next step, organize leads and automate marketing operations with n8n when the process has a clear purpose.", href: "/services/cro-marketing-automation", link: "Discuss CRO and automation →" },
        { label: "13 · Consulting", title: "Marketing Consulting", description: "Positioning, audience, channel mix, offers and operating priorities for brands that need clearer marketing decisions.", href: "/services/marketing-consulting", link: "Explore Marketing Consulting →" },
      ],
  ...
  return (
    <div className="min-h-screen" dir={ar ? "rtl" : "ltr"} lang={lang}>
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-6 py-20"><div className="grid gap-6 md:grid-cols-2"><div className="rounded-2xl border border-border bg-surface p-8"><h2 className="text-2xl font-semibold">{data.fitTitle}</h2><p className="mt-4 leading-8 text-muted-foreground">{data.fitBody}</p></div><div className="rounded-2xl border border-border bg-surface p-8"><h2 className="text-2xl font-semibold">{ar ? "الخدمات المرتبطة" : "Connected services"}</h2><p className="mt-4 leading-8 text-muted-foreground">{ar ? "ابدأ من الخدمة الأقرب للمشكلة، ثم استخدم الروابط داخل كل صفحة لبناء منظومة مناسبة بدل تشتيت الجهد." : "Start with the service closest to the constraint, then use the connected pages to build the right system without scattering effort."}</p><div className="mt-5 flex flex-wrap gap-3">{[{ label: "International SEO", href: ar ? "/ar/services/international-multilingual-seo" : "/services/international-multilingual-seo" }, { label: "Keyword Research", href: ar ? "/ar/services/keyword-research-strategy" : "/services/keyword-research-strategy" }, { label: "Content SEO", href: ar ? "/ar/services/content-seo-copywriting" : "/services/content-seo-copywriting" }, { label: ar ? "استراتيجية المحتوى" : "Content Strategy", href: ar ? "/ar/content-strategy" : "/content-strategy" }].map((link) => <a key={link.href} href={link.href} className="text-sm text-primary hover:underline">{link.label} →</a>)}</div></div></div></section>
