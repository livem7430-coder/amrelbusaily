...
function getCopy(lang: SeoLanguage, mode: SeoPageMode): SeoCopy {
  ...
  if (ar) {
    ...
    if (mode === "expert") {
      return {
        title: "خبير سيو SEO محترف لزيادة العملاء والمبيعات | عمرو البصيلي",
        description: "عمرو البصيلي خبير سيو واستشاري تحسين محركات البحث للشركات والمتاجر. خدمات SEO تقنية ومحتوى عربي وإنجليزي لزيادة الظهور والعملاء والمبيعات.",
        eyebrow: "SEO EXPERT · STRATEGY · EXECUTION",
        heading: <>خبير سيو يحوّل <span className="text-gradient">الظهور في جوجل إلى عملاء.</span></>,
        intro: "أنا عمرو البصيلي، خبير سيو واستشاري تحسين محركات البحث بخبرة 7 سنوات وأكثر من 50 مشروعًا. أساعد الشركات والمتاجر في مصر والسعودية والإمارات والخليج على الظهور في جوجل وتحويل البحث العربي والإنجليزي إلى استفسارات ومبيعات قابلة للقياس.",
        answer: "خبير السيو هو المتخصص الذي يحسن بنية الموقع وصفحات الخدمات والمحتوى والروابط الداخلية حتى تفهمها محركات البحث وتصل إلى العملاء المناسبين. أبدأ بأوديت وخريطة كلمات بنية شراء، ثم أرتب التنفيذ حسب أثره على الاستفسارات والمبيعات. لا أبيع ضمان ترتيب؛ أقدم خطة واضحة وقياسًا يمكن مراجعته.",
        audienceTitle: "متى تحتاج إلى خبير سيو محترف؟",
        audience: common.audience,
        deliverablesTitle: "خدمات خبير السيو التي تحصل عليها",
        ...
        faqTitle: "أسئلة شائعة عن خبير السيو وتحسين محركات البحث",
        faq: [
          { q: "ما الفرق بين خبير سيو ووكالة SEO؟", a: "الخبير غالبًا يقود التشخيص والاستراتيجية مباشرة، بينما الوكالة قد توفر فريقًا أوسع للتنفيذ. القرار يعتمد على حجم العمل، سرعة الفريق الداخلي، وحاجتك للمحتوى أو التطوير، وليس على المسمى وحده." },
...
export function seoAuthorityHead(lang: SeoLanguage, mode: SeoPageMode) {
  ...
  return {
    meta: [
      ...
      { name: "keywords", content: lang === "ar" ? "خبير سيو, خبير SEO, متخصص سيو, استشاري سيو, خبير تحسين محركات البحث, أفضل خبير سيو, خدمات سيو, عمرو البصيلي" : "SEO expert, SEO consultant, freelance SEO specialist, hire SEO expert, Amr Elbusaily" },
